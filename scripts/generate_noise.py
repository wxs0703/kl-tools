...
def main():
    ...
    fibercube = FiberModelCube(meta_pars, default_obs_conf[1])
    noise = fibercube._getNoise(default_obs_conf[1])
...
if __name__ == '__main__':
    ...
    noise, sigma = main()
    with open('../../kl-nn/data_generate/notebooks/noise.pkl', 'wb') as f:
        pickle.dump((noise, sigma), f)
    print(f'sigma = {sigma}')
