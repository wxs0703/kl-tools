...
class InclinedExponential(IntensityMap):
    ...
    def _render(self, theta_pars, datavector, pars):
        ...
        dx_disk = 0 # pars.get("dx_disk", theta_pars['dx_disk']) * self.pars["hlr"]
        dy_disk = 0 # pars.get("dy_disk", theta_pars['dy_disk']) * self.pars["hlr"]
        dx_spec = 0 # pars.get("dx_spec", theta_pars['dx_spec']) * self.pars["hlr"]
        dy_spec = 0 # pars.get("dy_spec", theta_pars['dy_spec']) * self.pars["hlr"]
